        ...
        <div className="flex flex-col lg:flex-row items-center justify-between min-h-[80vh] gap-16 py-12">
          ...
          <div className="max-w-xl space-y-8 text-center lg:text-left">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-4 pt-2">
              <button className="px-7 py-3.5 bg-black text-white text-sm font-bold rounded-xl hover:bg-neutral-800 transition-all active:scale-95 shadow-xl shadow-neutral-900/10">
                Explore Products
              </button>
              <button className="px-7 py-3.5 bg-white text-black text-sm font-bold rounded-xl border border-neutral-200 hover:border-neutral-300 transition-all active:scale-95 shadow-sm">
                Watch Demo
              </button>
            </div>
          </div>
