      ...
      <main className="container mx-auto px-6 lg:px-16 max-w-7xl relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between min-h-[80vh] gap-16 py-12">
          ...
          <div className="max-w-xl space-y-8 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white border border-neutral-200/80 rounded-full shadow-xs text-neutral-600 text-xs font-semibold uppercase tracking-wider">
            ...
            <p className="text-neutral-500 text-lg max-w-md font-normal leading-relaxed mx-auto lg:mx-0">
              Your all-in-one smart retail assistant. Instant delivery, premium tracking, and global catalog access.
            </p>

            <div className="flex items-center justify-center lg:justify-start gap-4 pt-2">
              <button 
                onClick={() => navigate("/products")}
                className="px-7 py-3.5 bg-black text-white text-sm font-bold rounded-xl hover:bg-neutral-800 transition-all active:scale-95 shadow-xl shadow-neutral-900/10 cursor-pointer"
              >
                Explore Products
              </button>
              <button className="px-7 py-3.5 bg-white text-black text-sm font-bold rounded-xl border border-neutral-200 hover:border-neutral-300 transition-all active:scale-95 shadow-xs cursor-pointer">
                Watch Demo
              </button>
            </div>
          </div>
          ...
          <div className="w-full max-w-md relative group">
            <div className="bg-white/80 backdrop-blur-md border border-white/60 rounded-3xl p-8 sm:p-10 shadow-[0_32px_64px_-12px_rgba(0,0,0,0.06)] ring-1 ring-black/5">
              <div className="space-y-2 mb-8 text-center sm:text-left">
                <h2 className="text-3xl font-bold text-neutral-900 tracking-tight">
                  Get Started
                </h2>
                <p className="text-neutral-400 text-sm">
                  Create an account to unlock personalized deals.
                </p>
              </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative flex items-center">
                    ...
                    <button
                      ...
                      className="absolute right-4 text-neutral-400 hover:text-black transition-all duration-200 cursor-pointer"
                    >
              ...
              <div>
                <button
                  type="button"
                  className="w-full flex items-center justify-center gap-3 h-12 bg-white border border-neutral-200 text-black hover:bg-neutral-50 py-3.5 rounded-xl transition active:scale-[0.98] text-sm font-bold shadow-xs cursor-pointer"
                  onClick={googleSignup}
                >
                  <img src={google} alt="Google" className="w-5 h-5 rounded-sm object-contain" />
